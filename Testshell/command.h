...
public:
  bool execute(TestShell *shell, const Command &command) override;
...
public:
  ...
  string getDescription() const override {
    return "Write <value> to the entire SSD";
  }
...
public:
  ...
  string getDescription() const override {
    return "Read from SSD at logical block address <lba>";
  }
...
public:
  ...
  string getDescription() const override {
    return "Write <value> to SSD at logical block address <lba>";
  }
...
public:
  ...
  string getUsage() const override { return "<value>"; }
  string getDescription() const override {
    return "Run comprehensive write/read test for entire SSD";
  }
  string getExample() const override {
    return "'1_' or '1_FullWriteAndReadCompare'";
  }
...
public:
  ...
  string getUsage() const override { return "<value>"; }
  string getDescription() const override {
    return "Run partial LBA write consistency test (30 iterations)";
  }
...
public:
  ...
  string getUsage() const override { return ""; }
  string getDescription() const override {
    return "Repeatedly erase LBA ranges and write random data to following "
           "LBAs in sequential loops (30 iterations)";
  }
  string getExample() const override {
